...
abstract class AdminPageFramework_UserMeta_Model extends AdminPageFramework_UserMeta_Router {
    ...
    protected function _setOptionArray($iUserID) {
        ...
        $_aOptions = AdminPageFramework_WPUtility::addAndApplyFilter($this, 'options_' . $this->oProp->sClassName, $_aOptions);
        $_aLastInput = isset($_GET['field_errors']) && $_GET['field_errors'] ? $this->oProp->aLastInput : array();
...
abstract class AdminPageFramework_Menu_Model extends AdminPageFramework_Page_Controller {
    ...
    private function _addPageSubmenuItem($sRootPageSlug, $sMenuSlug, $sPageSlug, $sPageTitle, $sMenuTitle, $sCapability, $bShowInMenu) {
        $_sPageHook = add_submenu_page($sRootPageSlug, $sPageTitle, $sMenuTitle, $sCapability, $sPageSlug, array($this, $this->oProp->sClassHash . '_page_' . $sPageSlug));#__print($sRootPageSlug.'<>'.$sPageTitle.'<>'.$sCapability.'=>'.$sPageSlug);
...
class AdminPageFramework_FormElement_Utility extends AdminPageFramework_WPUtility {
    ...
    public function applyFiltersToFields($oCaller, $sClassName) {#_print($this->aConditionedFields);
...
class AdminPageFramework_FormElement extends AdminPageFramework_FormElement_Utility {
    ...
    public function addField($asField) {
        ...
        $this->aFields[$_aFIeld['section_id']][$_aFIeld['field_id']] = $_aFIeld;#_print($_aFIeld);
        return $_aFIeld;
    }
...
class AdminPageFramework_FormField extends AdminPageFramework_FormField_Base {
    ...
    private function _getFieldsOutput(array $aFields, array $aCallbacks = array()) {@session_start();
        $_aOutput = array();
        foreach ($aFields as $__sKey => $__aField) {
            ...
            $__aField['_index'] = $__sKey;#_print($__sKey);
...
class AdminPageFramework_Input_checkbox extends AdminPageFramework_Input_Base {
    ...
    public function getAttributeArray() {
        $_aParams = func_get_args() + array(0 => '',);#_print($_aParams);
        $_sKey = $_aParams[0];
...
class AdminPageFramework_Input_select extends AdminPageFramework_Input_Base {
    ...
    private function _getDropDownList($sInputID, array $aLabels, array $aAttributes) {
        ...
        foreach ($aLabels as $__sKey => $__asLabel) {
            ...
            $_sLabel = $__asLabel;#_print($__sKey);
...
class AdminPageFramework_FormTable extends AdminPageFramework_FormTable_Caption {
    public function getFormTables($aSections, $aFieldsInSections, $hfSectionCallback, $hfFieldCallback) {
        ...
        return implode(PHP_EOL, $_aOutput) . $this->_getSectionTabsEnablerScript() . (defined('WP_DEBUG') && WP_DEBUG && in_array($_sFieldsType, array('widget', 'post_meta_box', 'page_meta_box', 'user_meta')) ? "<div class='admin-page-framework-info'>" . 'Debug Info: ' . AdminPageFramework_Registry::Name . ' ' . AdminPageFramework_Registry::getVersion() . "</div>" : '');
    }
